...
const Atoms = [
	...
	atom(5),
	atom(6000),
	atom<CharacterType>("None"),
	atom<InputPopup | undefined>({
		Data: {
	...
	atom<BaseObject<Model> | undefined>(undefined),
] as const;
const Story = {
	react: React,
	...
	story: (props: InferProps<typeof controls>) => {
		...
		return (
			<GameUI CharacterTypeAtom={Atoms[3]} RingsAtom={Atoms[0]} ScoreAtom={Atoms[2]} MultAtom={Atoms[0]} PopupAtom={Atoms[4]} HomingObjectAtom={Atoms[5]} />
		);
	},
};
